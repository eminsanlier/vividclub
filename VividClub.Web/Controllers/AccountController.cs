    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded && !this.userService.CheckIfDeletedByUserName(model.Username))
                {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userService.UserExistsByEmail(model.Email))
                {
                    ModelState.AddModelError(string.Empty, "There is an active member with provided email!");
                    return View(model);
                }

                var user = new User { UserName = model.Username, BirthDate = model.BirthDate, gender = model.Gender, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName,  ProfilePicture = this.photoService.PhotoAsBytes(model.Photo)};
